      ...
      <div>
        ...
        <div className="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              We plan and execute seamless migrations and rebuilds, modernizing
              legacy sites without disrupting publishing workflows or ad
              revenue.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Connect editorial tools, analytics, and ad tech with custom
              middleware and API integrations that streamline your publishing
              stack.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Unify your audience strategy with tailored newsletter systems and
              ESP integrations that boost engagement and deliverability.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Power content distribution with reliable, flexible feeds — from
              traditional RSS to modern syndication and AI content licensing
              pipelines.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Optimize your site architecture, metadata, and structured data to
              improve discoverability, boost rankings, and strengthen audience
              reach.
            </p>
          </div>
        </div>
